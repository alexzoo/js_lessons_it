...
function nearestValue(values, search) {
    return values.reduce(function (prev, curr) { return Math.abs(curr - search) < Math.abs(prev - search) ? curr : prev; });
}
console.log(nearestValue([2, 42, 82, 122, 162, 202, 242, 282, 322, 362], 240));
///
